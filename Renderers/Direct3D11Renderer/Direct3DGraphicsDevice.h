...
public:
	// Constructors
	Direct3DGraphicsDevice(cobalt::logging::ILogger* log, Microsoft::WRL::ComPtr<IDXGIFactory2> dxgiFactory, Microsoft::WRL::ComPtr<IDXGIAdapter2> adapter, const DXGI_ADAPTER_DESC2& adapterDescription);
