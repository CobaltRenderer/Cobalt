...
class Direct3DTextureBufferCube : public Direct3DTextureBuffer<ITextureBufferCube, V2UInt32>
{
public:
	// Constructors
	inline Direct3DTextureBufferCube(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
	inline ~Direct3DTextureBufferCube();
...
#include "Direct3DTextureBufferCube.inl"
