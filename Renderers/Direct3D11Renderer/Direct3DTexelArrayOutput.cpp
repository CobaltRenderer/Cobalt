...
// Constructors
//----------------------------------------------------------------------------------------
Direct3DTexelArrayOutput::Direct3DTexelArrayOutput(cobalt::logging::ILogger* log, Direct3DRenderer* renderer)
...
//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::Delete()
{
...
//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::SetDetachAfterCapture(bool state)
{
...
//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::SetArrayCaptureRegion(size_t captureEntryCount, size_t bufferOffset)
{
...
// Data methods
//----------------------------------------------------------------------------------------
bool Direct3DTexelArrayOutput::HasCapturedOutput() const
{
	return _state[ReadIndex()].hasCapturedOutput;
}

//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::ClearCapturedOutput()
{
...
//----------------------------------------------------------------------------------------
size_t Direct3DTexelArrayOutput::GetEntryCount() const
{
...
//----------------------------------------------------------------------------------------
ITexelArray::SourceImageFormat Direct3DTexelArrayOutput::GetOptimalImageFormat() const
{
...
//----------------------------------------------------------------------------------------
ITexelArray::SourceDataFormat Direct3DTexelArrayOutput::GetOptimalDataFormat() const
{
...
//----------------------------------------------------------------------------------------
SuccessToken Direct3DTexelArrayOutput::ReadBufferData(void* targetBuffer, size_t targetBufferSizeInBytes, ITexelArray::SourceImageFormat imageFormat, ITexelArray::SourceDataFormat dataFormat) const
{
...
// Capture methods
//----------------------------------------------------------------------------------------
bool Direct3DTexelArrayOutput::IsDetachingAfterCapture() const
{
	return _state[_drawIndex].detachAfterCapture;
}

//----------------------------------------------------------------------------------------
size_t Direct3DTexelArrayOutput::GetRequestedEntryCount() const
{
	return _state[_drawIndex].requestedCaptureEntryCount;
}

//----------------------------------------------------------------------------------------
size_t Direct3DTexelArrayOutput::GetRequestedBufferOffset() const
{
	return _state[_drawIndex].requestedBufferOffset;
}

//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::StoreCaptureData(const unsigned char* bufferData, size_t bufferEntryCount, size_t bufferEntrySizeInBytes, ITexelArray::ImageFormat imageFormat, ITexelArray::DataFormat dataFormat)
{
...
//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::EnableCaptureReadFromCurrentDrawBuffer()
{
...
// Build state methods
//----------------------------------------------------------------------------------------
void Direct3DTexelArrayOutput::MigrateBuildStateToDrawState()
{
...
//----------------------------------------------------------------------------------------
uint32_t Direct3DTexelArrayOutput::ReadIndex() const
{
