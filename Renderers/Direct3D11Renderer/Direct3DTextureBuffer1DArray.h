...
class Direct3DTextureBuffer1DArray : public Direct3DTextureBuffer<ITextureBuffer1DArray, V1UInt32>
{
public:
	// Constructors
	inline Direct3DTextureBuffer1DArray(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
	inline ~Direct3DTextureBuffer1DArray();
...
#include "Direct3DTextureBuffer1DArray.inl"
