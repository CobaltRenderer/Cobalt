...
class Direct3DTextureBuffer1D : public Direct3DTextureBuffer<ITextureBuffer1D, V1UInt32>
{
public:
	// Constructors
	inline Direct3DTextureBuffer1D(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
	inline ~Direct3DTextureBuffer1D();
...
#include "Direct3DTextureBuffer1D.inl"
