...
class Direct3DTextureBuffer2DArray : public Direct3DTextureBuffer<ITextureBuffer2DArray, V2UInt32>
{
public:
	// Constructors
	inline Direct3DTextureBuffer2DArray(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
	inline ~Direct3DTextureBuffer2DArray();
...
#include "Direct3DTextureBuffer2DArray.inl"
