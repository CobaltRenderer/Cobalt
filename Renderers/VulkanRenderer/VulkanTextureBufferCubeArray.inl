...
// Constructors
//----------------------------------------------------------------------------------------
VulkanTextureBufferCubeArray::VulkanTextureBufferCubeArray(cobalt::logging::ILogger* log, VulkanRenderer* renderer)
: VulkanTextureBuffer<ITextureBufferCubeArray, V2UInt32>(log, renderer)
{}

//----------------------------------------------------------------------------------------
// Initialization methods
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::Delete()
{
...
// Build state methods
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::FlagObjectModified()
{
	Renderer()->FlagObjectModified(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::ScheduleGraphicsQueueAcquireOperation()
{
	Renderer()->ScheduleGraphicsQueueAcquireOperation(this);
}

//----------------------------------------------------------------------------------------
bool VulkanTextureBufferCubeArray::CancelPendingGraphicsQueueAcquireOperation()
{
	return Renderer()->CancelPendingGraphicsQueueAcquireOperation(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::AddBatchTransferInitializeOperation(VulkanTransferBatch* transferBatch)
{
	transferBatch->AddInitializeOperation(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::AddBatchTransferFinalizeOperation(VulkanTransferBatch* transferBatch)
{
	transferBatch->AddFinalizeOperation(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::PopulateImageCreateInfo(VkImageCreateInfo& imageCreateInfo, VkFormat nativeFormat, VkImageUsageFlags usageFlags, VkImageCreateFlags createFlags) const
{
...
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::PopulateImageViewCreateInfo(VkImageViewCreateInfo& imageViewCreateInfo, VkImage image, VkImageAspectFlagBits aspectFlags, VkFormat nativeFormat) const
{
	size_t arraySize = ArraySize();
	int mipmapLevels = MipmapLevelCount();
	imageViewCreateInfo = {};
...
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::PopulateImageCopyRegion(const InitialDataEntry& entry, VkImageAspectFlagBits aspectFlags, VkBufferImageCopy& imageCopyRegion) const
{
...
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCubeArray::PopulateImageCopyRegion(const PendingWrite& entry, VkImageAspectFlagBits aspectFlags, VkBufferImageCopy& imageCopyRegion) const
{
	auto imageDimensions = MipmapLevelDimensions(entry.mipmapLevel);
