...
class VulkanTextureSampler2D : public VulkanTextureSampler<ITextureSampler2D>
{
public:
	// Constructors
	inline VulkanTextureSampler2D(cobalt::logging::ILogger* log, VulkanRenderer* renderer);
...
#include "VulkanTextureSampler2D.inl"
