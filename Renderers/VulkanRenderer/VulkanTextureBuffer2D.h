...
class VulkanTextureBuffer2D : public VulkanTextureBuffer<ITextureBuffer2D, V2UInt32>
{
public:
	// Constructors
	inline VulkanTextureBuffer2D(cobalt::logging::ILogger* log, VulkanRenderer* renderer);
...
#include "VulkanTextureBuffer2D.inl"
