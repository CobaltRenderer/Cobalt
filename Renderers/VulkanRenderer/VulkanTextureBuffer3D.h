...
class VulkanTextureBuffer3D : public VulkanTextureBuffer<ITextureBuffer3D, V3UInt32>
{
public:
	// Constructors
	inline VulkanTextureBuffer3D(cobalt::logging::ILogger* log, VulkanRenderer* renderer);
...
#include "VulkanTextureBuffer3D.inl"
