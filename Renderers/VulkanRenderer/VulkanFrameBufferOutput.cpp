...
// Constructors
//----------------------------------------------------------------------------------------
VulkanFrameBufferOutput::VulkanFrameBufferOutput(cobalt::logging::ILogger* log, VulkanRenderer* renderer)
...
//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::Delete()
{
...
//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::SetDetachAfterCapture(bool state)
{
...
//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::SetFrameBufferCaptureRegion(const V2UInt32& imageOffsetInPixels, const V2UInt32& imageRegionInPixels)
{
...
// Data methods
//----------------------------------------------------------------------------------------
bool VulkanFrameBufferOutput::HasCapturedOutput() const
{
	return _state[ReadIndex()].hasCapturedOutput;
}

//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::ClearCapturedOutput()
{
...
//----------------------------------------------------------------------------------------
V2UInt32 VulkanFrameBufferOutput::GetImageDimensions() const
{
	return _state[ReadIndex()].actualImageSize;
}

//----------------------------------------------------------------------------------------
V2UInt32 VulkanFrameBufferOutput::GetCroppedImageDimensions(const V2UInt32& imageOffsetInPixels, const V2UInt32& imageRegionInPixels) const
{
	return CalculateCroppedImageDimensions(GetImageDimensions(), imageOffsetInPixels, imageRegionInPixels);
}

//----------------------------------------------------------------------------------------
V2UInt32 VulkanFrameBufferOutput::CalculateCroppedImageDimensions(const V2UInt32& imageSizeInPixels, const V2UInt32& imageOffsetInPixels, const V2UInt32& imageRegionInPixels)
{
...
//----------------------------------------------------------------------------------------
size_t VulkanFrameBufferOutput::CalculatePixelCountForRegion(const V2UInt32& imageOffsetInPixels, const V2UInt32& imageRegionInPixels) const
{
...
//----------------------------------------------------------------------------------------
ITextureBuffer::SourceImageFormat VulkanFrameBufferOutput::GetOptimalImageFormat() const
{
...
//----------------------------------------------------------------------------------------
ITextureBuffer::SourceDataFormat VulkanFrameBufferOutput::GetOptimalDataFormat() const
{
...
//----------------------------------------------------------------------------------------
SuccessToken VulkanFrameBufferOutput::ReadBufferData(void* targetBuffer, size_t targetBufferSizeInBytes, ITextureBuffer::SourceImageFormat imageFormat, ITextureBuffer::SourceDataFormat dataFormat, const V2UInt32& imageOffsetInPixels, const V2UInt32& imageRegionInPixels) const
{
...
// Capture methods
//----------------------------------------------------------------------------------------
bool VulkanFrameBufferOutput::IsDetachingAfterCapture() const
{
	return _state[_drawIndex].detachAfterCapture;
}

//----------------------------------------------------------------------------------------
V2UInt32 VulkanFrameBufferOutput::GetRequestedImageOffset() const
{
	return _state[_drawIndex].requestedImageOffset;
}

//----------------------------------------------------------------------------------------
V2UInt32 VulkanFrameBufferOutput::GetRequestedImageSize() const
{
	return _state[_drawIndex].requestedImageSize;
}

//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::StoreCaptureData(const V2UInt32& imageSize, const unsigned char* imageData, size_t imageDataSizeInBytes, ITextureBuffer::ImageFormat imageFormat, ITextureBuffer::DataFormat dataFormat, size_t elementCount, size_t elementSizeInBytes, size_t pixelOffsetInBytes, size_t pixelStrideInBytes, size_t rowStrideInBytes, bool isStencilComponent)
{
...
//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::EnableCaptureReadFromCurrentDrawBuffer()
{
...
// Build state methods
//----------------------------------------------------------------------------------------
void VulkanFrameBufferOutput::MigrateBuildStateToDrawState()
{
...
//----------------------------------------------------------------------------------------
uint32_t VulkanFrameBufferOutput::ReadIndex() const
{
