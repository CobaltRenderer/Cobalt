...
class VulkanTextureBuffer2DArray : public VulkanTextureBuffer<ITextureBuffer2DArray, V2UInt32>
{
public:
	// Constructors
	inline VulkanTextureBuffer2DArray(cobalt::logging::ILogger* log, VulkanRenderer* renderer);
...
#include "VulkanTextureBuffer2DArray.inl"
