...
// Constructors
//----------------------------------------------------------------------------------------
VulkanTextureBufferCube::VulkanTextureBufferCube(cobalt::logging::ILogger* log, VulkanRenderer* renderer)
: VulkanTextureBuffer<ITextureBufferCube, V2UInt32>(log, renderer)
{}

//----------------------------------------------------------------------------------------
// Initialization methods
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::Delete()
{
...
// Build state methods
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::FlagObjectModified()
{
	Renderer()->FlagObjectModified(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::ScheduleGraphicsQueueAcquireOperation()
{
	Renderer()->ScheduleGraphicsQueueAcquireOperation(this);
}

//----------------------------------------------------------------------------------------
bool VulkanTextureBufferCube::CancelPendingGraphicsQueueAcquireOperation()
{
	return Renderer()->CancelPendingGraphicsQueueAcquireOperation(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::AddBatchTransferInitializeOperation(VulkanTransferBatch* transferBatch)
{
	transferBatch->AddInitializeOperation(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::AddBatchTransferFinalizeOperation(VulkanTransferBatch* transferBatch)
{
	transferBatch->AddFinalizeOperation(this);
}

//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::PopulateImageCreateInfo(VkImageCreateInfo& imageCreateInfo, VkFormat nativeFormat, VkImageUsageFlags usageFlags, VkImageCreateFlags createFlags) const
{
...
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::PopulateImageViewCreateInfo(VkImageViewCreateInfo& imageViewCreateInfo, VkImage image, VkImageAspectFlagBits aspectFlags, VkFormat nativeFormat) const
{
	int mipmapLevels = MipmapLevelCount();
	imageViewCreateInfo = {};
...
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::PopulateImageCopyRegion(const InitialDataEntry& entry, VkImageAspectFlagBits aspectFlags, VkBufferImageCopy& imageCopyRegion) const
{
...
//----------------------------------------------------------------------------------------
void VulkanTextureBufferCube::PopulateImageCopyRegion(const PendingWrite& entry, VkImageAspectFlagBits aspectFlags, VkBufferImageCopy& imageCopyRegion) const
{
	auto imageDimensions = MipmapLevelDimensions(entry.mipmapLevel);
