...
class VulkanStateBufferLayout : public IStateBufferLayout
{
public:
	// Structures
	struct FieldEntry
...
public:
	// Constructors
	VulkanStateBufferLayout(cobalt::logging::ILogger* log, VulkanRenderer* renderer);
...
#include "VulkanStateBufferLayout.inl"
