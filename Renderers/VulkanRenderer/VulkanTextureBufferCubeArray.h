...
class VulkanTextureBufferCubeArray : public VulkanTextureBuffer<ITextureBufferCubeArray, V2UInt32>
{
public:
	// Constructors
	inline VulkanTextureBufferCubeArray(cobalt::logging::ILogger* log, VulkanRenderer* renderer);
...
#include "VulkanTextureBufferCubeArray.inl"
