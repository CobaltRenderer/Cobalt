...
// Predeclarations
extern "C" FUNCTION_EXPORT IGraphicsDeviceEnumerator* CreateOpenGL3Renderer(cobalt::logging::ILogger* log);
extern "C" FUNCTION_EXPORT bool GetOpenGL3RendererPlugin(IRendererPlugin& rendererPlugin);
...
extern "C" FUNCTION_EXPORT bool GetOpenGL3RendererPlugin(IRendererPlugin& rendererPlugin)
{
	rendererPlugin.SetAllocationFunction(CreateOpenGL3Renderer);
	rendererPlugin.SetApiFamily(IRendererPlugin::ApiFamily::OpenGL);
	rendererPlugin.SetTargetApiVersion(IRendererPlugin::ApiVersion(3, 3));
	rendererPlugin.SetName("OpenGL3_3");
	rendererPlugin.SetDisplayName("OpenGL 3.3 Core");
	return true;
}
...
extern "C" FUNCTION_EXPORT bool GetRendererPlugin(unsigned int indexNo, IRendererPlugin& rendererPlugin)
{
	...
	{
	case 0:
		return GetOpenGL3RendererPlugin(rendererPlugin);
	}
	return false;
}
