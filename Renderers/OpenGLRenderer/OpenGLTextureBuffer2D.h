...
class OpenGLTextureBuffer2D : public OpenGLTextureBuffer<ITextureBuffer2D, V2UInt32>
{
public:
	// Constructors
	inline OpenGLTextureBuffer2D(cobalt::logging::ILogger* log, OpenGLRenderer* renderer);
...
#include "OpenGLTextureBuffer2D.inl"
