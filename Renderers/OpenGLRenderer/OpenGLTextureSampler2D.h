...
class OpenGLTextureSampler2D : public OpenGLTextureSampler<ITextureSampler2D>
{
public:
	// Constructors
	inline OpenGLTextureSampler2D(cobalt::logging::ILogger* log, OpenGLRenderer* renderer);
...
#include "OpenGLTextureSampler2D.inl"
