...
class OpenGLTransferBatch : public ITransferBatch
{
public:
	// Constructors
	OpenGLTransferBatch(cobalt::logging::ILogger* log, OpenGLRenderer* renderer, StartTiming startTiming, EndTiming endTiming);
