...
class OpenGLTextureBuffer3D : public OpenGLTextureBuffer<ITextureBuffer3D, V3UInt32>
{
public:
	// Constructors
	inline OpenGLTextureBuffer3D(cobalt::logging::ILogger* log, OpenGLRenderer* renderer);
...
#include "OpenGLTextureBuffer3D.inl"
