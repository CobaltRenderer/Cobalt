...
class OpenGLTextureBufferCubeArray : public OpenGLTextureBuffer<ITextureBufferCubeArray, V2UInt32>
{
public:
	// Constructors
	inline OpenGLTextureBufferCubeArray(cobalt::logging::ILogger* log, OpenGLRenderer* renderer);
...
#include "OpenGLTextureBufferCubeArray.inl"
