...
SuccessToken Direct3DGraphicsDeviceEnumerator::EnumerateDevices(EnumerationFlags flags)
{
	...
	//##TODO## Look into using IDXGIFactory4::EnumWarpAdapter to support the WARP layer
	...
	if (_devices.empty())
	{
		_log->Warning("No compatible Direct3D 12 devices were located during device enumeration.");
	}
