...
class Direct3DTextureSampler3D : public Direct3DTextureSampler<ITextureSampler3D>
{
public:
	// Constructors
	inline Direct3DTextureSampler3D(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
...
#include "Direct3DTextureSampler3D.inl"
