...
// Constructors
//----------------------------------------------------------------------------------------
Direct3DDataArrayOutput::Direct3DDataArrayOutput(cobalt::logging::ILogger* log, Direct3DRenderer* renderer)
...
//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::Delete()
{
...
//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::SetDetachAfterCapture(bool state)
{
...
//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::SetArrayCaptureRegion(size_t captureEntryCount, size_t bufferOffset, bool captureCounterValue)
{
...
// Data methods
//----------------------------------------------------------------------------------------
bool Direct3DDataArrayOutput::HasCapturedOutput() const
{
	return _state[ReadIndex()].hasCapturedOutput;
}

//----------------------------------------------------------------------------------------
bool Direct3DDataArrayOutput::HasCapturedCounterValue() const
{
	return _state[ReadIndex()].hasCapturedOutput && _state[ReadIndex()].hasCapturedCounterValue;
}

//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::ClearCapturedOutput()
{
...
//----------------------------------------------------------------------------------------
size_t Direct3DDataArrayOutput::GetEntryCount() const
{
...
//----------------------------------------------------------------------------------------
size_t Direct3DDataArrayOutput::GetEntrySizeInBytes() const
{
	if (!_state[ReadIndex()].hasCapturedOutput)
	{
		return 0;
...
//----------------------------------------------------------------------------------------
SuccessToken Direct3DDataArrayOutput::ReadBufferData(void* targetBuffer, size_t targetBufferSizeInBytes) const
{
...
//----------------------------------------------------------------------------------------
SuccessToken Direct3DDataArrayOutput::ReadCounterValue(uint32_t& counterValue) const
{
...
// Capture methods
//----------------------------------------------------------------------------------------
bool Direct3DDataArrayOutput::IsDetachingAfterCapture() const
{
	return _state[_drawIndex].detachAfterCapture;
}

//----------------------------------------------------------------------------------------
size_t Direct3DDataArrayOutput::GetRequestedEntryCount() const
{
	return _state[_drawIndex].requestedCaptureEntryCount;
}

//----------------------------------------------------------------------------------------
size_t Direct3DDataArrayOutput::GetRequestedBufferOffset() const
{
	return _state[_drawIndex].requestedBufferOffset;
}

//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::StoreCaptureData(const unsigned char* bufferData, size_t bufferEntryCount, size_t bufferEntrySizeInBytes, bool hasCounterValue, uint32_t counterValue)
{
...
//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::EnableCaptureReadFromCurrentDrawBuffer()
{
...
// Build state methods
//----------------------------------------------------------------------------------------
void Direct3DDataArrayOutput::MigrateBuildStateToDrawState()
{
...
//----------------------------------------------------------------------------------------
uint32_t Direct3DDataArrayOutput::ReadIndex() const
{
