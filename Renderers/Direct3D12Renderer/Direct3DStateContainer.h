...
template<class T>
class Direct3DStateContainer : public Direct3DNode<T>
{
public:
	// Constructors
	explicit Direct3DStateContainer(cobalt::logging::ILogger* log);
	~Direct3DStateContainer();
...
#include "Direct3DStateContainer.inl"
