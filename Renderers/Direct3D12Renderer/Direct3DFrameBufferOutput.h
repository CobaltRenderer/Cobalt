...
class Direct3DFrameBufferOutput : public IFrameBufferOutput
{
public:
	// Constructors
	Direct3DFrameBufferOutput(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
