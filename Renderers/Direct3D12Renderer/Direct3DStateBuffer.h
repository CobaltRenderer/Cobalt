...
public:
	...
	// Binding methods
	bool GetStateBufferPageGpuAddress(uint32_t pageNo, D3D12_GPU_VIRTUAL_ADDRESS& gpuAddress) const;
	...
	void CompletePendingDataWritesForPageBlock(ID3D12GraphicsCommandList* commandList, uint32_t targetPageBlockNo);
...
private:
	...
	// Build state methods
	void CompletePendingDataWritesForPageBlock(ID3D12GraphicsCommandList* commandList, PageBlock& pageBlock);
