...
class Direct3DStateBufferLayout : public IStateBufferLayout
{
public:
	// Structures
	struct FieldEntry
...
public:
	// Constructors
	Direct3DStateBufferLayout(cobalt::logging::ILogger* log, Direct3DRenderer* renderer);
	...
	inline constexpr static size_t GetDataTypeByteSize(DataType dataType);
...
#include "Direct3DStateBufferLayout.inl"
