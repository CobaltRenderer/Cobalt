...
DEFINE_UNIT_TEST_WITH_BASE("Performance/LargePolyCount", PerformanceTestBase)
{
	...
	// node.
	size_t primitiveCount = 100;
	uint32_t vertexCountWidth = 708;
	uint32_t vertexCountHeight = 708;
	...
	session.AddTestProfileResult("LargePolyCount", "100 spheres with 1002528 triangles each", profileResults);
