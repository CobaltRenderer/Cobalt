...
DEFINE_UNIT_TEST_WITH_BASE("Performance/MinimalScene", PerformanceTestBase)
{
	...
	session.AddTestProfileResult("MinimalScene", "A single triangle in a single render pass", profileResults);
