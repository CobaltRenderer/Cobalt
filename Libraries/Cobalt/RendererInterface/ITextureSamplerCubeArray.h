...
class ITextureSamplerCubeArray : public ITextureSampler
{
public:
	// Typedefs
	typedef std::unique_ptr<ITextureSamplerCubeArray, Deleter<ITextureSamplerCubeArray>> unique_ptr;
...
protected:
	// Constructors
	~ITextureSamplerCubeArray() = default;
};
