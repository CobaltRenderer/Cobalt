...
public:
	// Constructors
	inline In(const ContainerType& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(source)
	{}
	inline In(const InOut<ContainerType>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._sourceReference), _source((no_bound_object_tag*)0)
	{}
	inline In(const Ret<ContainerType>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._data->GetMarshaller()), _source((no_bound_object_tag*)0)
	{}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	inline In(ContainerType&& source) // NOLINT(hicpp-explicit-conversions)
...
private:
	...
	In(const In& source) MARSHALSUPPORT_DELETEMETHOD;            // NOLINT(hicpp-use-equals-delete,modernize-use-equals-delete)
	In& operator=(const In& source) MARSHALSUPPORT_DELETEMETHOD; // NOLINT(hicpp-use-equals-delete,modernize-use-equals-delete)
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	In(In&& source) MARSHALSUPPORT_DELETEMETHOD;            // NOLINT(hicpp-use-equals-delete,modernize-use-equals-delete)
	In& operator=(In&& source) MARSHALSUPPORT_DELETEMETHOD; // NOLINT(hicpp-use-equals-delete,modernize-use-equals-delete)
#endif
...
public:
	// Constructors
	inline In(const std::vector<ElementType, Alloc>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(source)
	{}
	inline In(const InOut<std::vector<ElementType, Alloc>>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._sourceReference), _source((no_bound_object_tag*)0)
	{}
	inline In(const Ret<std::vector<ElementType, Alloc>>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._data->GetMarshaller()), _source((no_bound_object_tag*)0)
	{}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	inline In(std::vector<ElementType, Alloc>&& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(std::move(source))
	{}
#endif
...
public:
	// Constructors
	inline In(const std::array<ElementType, ArraySize>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(source)
	{}
	inline In(const InOut<std::array<ElementType, ArraySize>>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._sourceReference), _source((no_bound_object_tag*)0)
	{}
	inline In(const Ret<std::array<ElementType, ArraySize>>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._data->GetMarshaller()), _source((no_bound_object_tag*)0)
	{}
	inline In(std::array<ElementType, ArraySize>&& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(std::move(source))
	{}
...
public:
	// Constructors
	inline In(const std::basic_string<ElementType, traits, Alloc>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(source)
	{}
	inline In(const InOut<std::basic_string<ElementType, traits, Alloc>>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._sourceReference), _source((no_bound_object_tag*)0)
	{}
	inline In(const Ret<std::basic_string<ElementType, traits, Alloc>>& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(source._data->GetMarshaller()), _source((no_bound_object_tag*)0)
	{}
	inline In(const ElementType* source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(source)
	{}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	inline In(std::basic_string<ElementType, traits, Alloc>&& source) // NOLINT(hicpp-explicit-conversions)
	: _sourceReference(_source), _source(std::move(source))
	{}
#endif
...
public:
	// Constructors
	inline In(std::unique_ptr<T, Deleter>&& source) // NOLINT(hicpp-explicit-conversions)
