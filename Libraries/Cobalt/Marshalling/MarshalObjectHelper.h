...
//----------------------------------------------------------------------------------------
template<class ElementType, bool HasMashalConstructor = has_marshal_constructor<ElementType>::value, bool IsOnlyMovable = marshalling::internal::is_only_movable<typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type>::value, bool IsAssignable = marshalling::internal::is_assignable<ElementType>::value>
