...
protected:
	...
	// Marshalling methods
	virtual void MARSHALSUPPORT_CALLINGCONVENTION MarshalFromFlatArrays(size_t elementByteSize, void* itemArray, const size_t* elementSizeArray, marshalling::internal::INestedMarshallerBase* const* nestedMarshallerArray) const = 0;
...
private:
	...
	public:
		// Constructors
		explicit ScopedFreeDataArrayHelper(const IMarshalTargetInternal& atargetMarshaller)
		...
		~ScopedFreeDataArrayHelper()
		{
			...
			marshalling::internal::DeleteSTLContainerItemArray(itemArray, (ContainerType*)0);
			delete[] elementSizeArray;
			if (marshalling::internal::nested_container_has_keys<ContainerType>::value)
			{
				marshalling::internal::DeleteSTLContainerKeyMarshallers(nestedMarshallerArray, 0, (ContainerType*)0);
	...
	public:
		...
		marshalling::internal::INestedMarshallerBase** nestedMarshallerArray;
	};
...
private:
	...
	void MarshalFromInternal(MARSHALSUPPORT_UNIVERSALREFERENCE(FullType) sourceObject) const
	{
		...
		marshalling::internal::CalculateDecomposedSTLContainerSize(itemArraySize, elementSizeArraySize, sourceObject);
		...
		arrayHelper.itemArray = marshalling::internal::CreateSTLContainerItemArray(itemArraySize, &sourceObject);
		...
		if (marshalling::internal::nested_container_has_keys<ContainerType>::value)
		{
			...
			arrayHelper.nestedMarshallerArray = new marshalling::internal::INestedMarshallerBase*[nestingDepth];
			marshalling::internal::CreateSTLContainerKeyMarshallers(arrayHelper.nestedMarshallerArray, 0, (ContainerType*)0);
		}
		...
		marshalling::internal::DecomposeSTLContainer(arrayHelper.itemArray, arrayHelper.elementSizeArray, arrayHelper.nestedMarshallerArray, elementArrayIndex, elementSizeArrayIndex, nestedMarshallerArrayIndex, MARSHALSUPPORT_FORWARD(MARSHALSUPPORT_UNIVERSALREFERENCE(FullType), sourceObject));

		// Recompose our flat arrays into the target container
		MarshalFromFlatArrays(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ContainerType>::type), arrayHelper.itemArray, arrayHelper.elementSizeArray, arrayHelper.nestedMarshallerArray);
	}
};
...
public:
	...
	inline void MarshalFrom(ContainerType&& sourceObject) const
	{
		...
		size_t elementSizeArrayIndex = 0;
		size_t nestedMarshallerArrayIndex = 0;
		marshalling::internal::DecomposeSTLContainer(arrayHelper.itemArray, arrayHelper.elementSizeArray, arrayHelper.nestedMarshallerArray, elementArrayIndex, elementSizeArrayIndex, nestedMarshallerArrayIndex, std::move(sourceObject));
...
class IMarshalTarget<ContainerType, false, IsThisOrNextElementLastElement, IsOnlyMovable> : public marshalling::internal::IMarshalTargetInternal<ContainerType, IsOnlyMovable>
{};
...
public:
	...
	inline void MarshalFrom(const ContainerType& sourceObject) const
	{
		MarshalDirectFromSource(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ContainerType>::type), sourceObject);
	}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	inline void MarshalFrom(ContainerType&& sourceObject) const
	{
		MarshalDirectFromSource(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ContainerType>::type), std::move(sourceObject));
	}
#endif
...
protected:
	...
	// which has not. This object needs to have the same virtual function table in both modules in order to allow them
	// to communicate. This same rule applies for other such occurrences in other IMarshalTarget specializations.
...
public:
	...
	{
		MarshalSetElement(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), static_cast<size_t>(index), &element);
	}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	...
	{
		MarshalPushBack(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), &element);
	}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	...
	{
		MarshalFrom(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), data, count);
	}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
...
private:
	...
	void MarshalFromInternal(MARSHALSUPPORT_UNIVERSALREFERENCE(FullType) sourceObject) const
	{
		...
		if (marshalling::internal::is_non_const_rvalue_reference<MARSHALSUPPORT_UNIVERSALREFERENCE(FullType)>::value)
		{
			MarshalFrom(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), const_cast<ElementType*>(sourceData), sourceObject.size());
		}
		else
		{
			MarshalFrom(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), sourceData, sourceObject.size());
		}
	}
};
...
protected:
	...
	virtual void MARSHALSUPPORT_CALLINGCONVENTION MarshalSetElement(size_t elementIndex, bool sourceData) const = 0;
	virtual void MARSHALSUPPORT_CALLINGCONVENTION MarshalPushBack(bool sourceData) const = 0;
	virtual void MARSHALSUPPORT_CALLINGCONVENTION MarshalRange(size_t elementIndex, const bool* sourceData, size_t sourceDataLength) const = 0;
	...
	virtual void MARSHALSUPPORT_CALLINGCONVENTION SetReservedSize(size_t newSize) const = 0;
	virtual size_t MARSHALSUPPORT_CALLINGCONVENTION GetSize() const = 0;
	virtual void MARSHALSUPPORT_CALLINGCONVENTION SetSize(size_t newSize, bool insertElement) const = 0;
};
...
public:
	...
	{
		MarshalRange(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), 0, data, ArraySize);
	}
#ifdef MARSHALSUPPORT_CPP11SUPPORTED
	inline void AssignFromWithMove(ElementType* data, size_t count) const
	{
...
private:
	...
	void MarshalFromInternal(MARSHALSUPPORT_UNIVERSALREFERENCE(FullType) sourceObject) const
	{
		...
		if (marshalling::internal::is_non_const_rvalue_reference<MARSHALSUPPORT_UNIVERSALREFERENCE(FullType)>::value)
		{
			MarshalRange(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), 0, const_cast<ElementType*>(sourceData), ArraySize);
		}
		else
		{
			MarshalRange(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), 0, sourceData, ArraySize);
		}
	}
};
...
public:
	...
	inline void MarshalFrom(std::array<ElementType, ArraySize>&& sourceObject) const
	{
		...
		// Marshal the contents of this container directly into the target object
		MarshalFrom(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), 0, sourceData, ArraySize);
	}
	...
	{
		MarshalFrom(sizeof(typename marshalling::internal::get_last_nested_container_element_type<ElementType>::type), 0, data, ArraySize);
	}
