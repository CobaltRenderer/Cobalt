...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:doc="http://www.cobaltrenderer.com/schema/XMLDocSchema.xsd">
  ...
  window.onload = function loadedFunction() {
    ...
    if (window.self == window.top) {
      window.top.location.href = '../index.html?page=' + pageName;
    }
    else {
      window.top.postMessage(pageName,'*');
    }
  }]]>
    </script>
      </head>
    ...
    <xsl:choose>
      <xsl:when test="@Type='Important'">
        <div class="importantBlock">
          <p><img title="Important" alt="Important" src="../images/icons/note.png" class="DarkModeAware"/><b>Important</b></p>
          <p><xsl:apply-templates/></p>
        </div>
      </xsl:when>
      <xsl:when test="@Type='Warning'">
        <div class="warningBlock">
          <p><img title="Warning" alt="Warning" src="../images/icons/caution.png" class="DarkModeAware"/><b>Warning</b></p>
          <p><xsl:apply-templates/></p>
        </div>
      </xsl:when>
    </xsl:choose>
      ...
      <xsl:when test="contains($TypeFilesPresentResolved,concat('[',@PageName,']'))">
        <xsl:choose>
          <xsl:when test="@Section">
            <a href="{@PageName}.html#{@Section}"><xsl:value-of select="."/></a>
          </xsl:when>
          <xsl:otherwise>
    ...
    <tr class="functionMembersRow">
      <td class="functionMembersData iconColumn">
        <xsl:if test="@Deprecated">
          <img title="Deprecated member" alt="Deprecated member" src="../images/icons/caution.png" class="DarkModeAware"/>
        </xsl:if>
        <xsl:if test="@Blocked">
          <img title="Blocked member. This member may be called internally, but is not available to be called directly from external code." alt="Blocked member" src="../images/icons/cross.png" class="DarkModeAware"/>
        </xsl:if>
        <xsl:if test="@Static">
          <img title="Static member" alt="Static member" src="../images/icons/static.gif" class="DarkModeAware"/>
        </xsl:if>
        <xsl:choose>
          <xsl:when test="@Visibility='Public'">
            <img title="Public member" alt="Public member" src="../images/icons/pubmethod.gif" class="DarkModeAware"/>
          </xsl:when>
          <xsl:when test="@Visibility='Protected'">
            <img title="Protected member" alt="Protected member" src="../images/icons/protmethod.gif" class="DarkModeAware"/>
          </xsl:when>
          <xsl:when test="@Visibility='Private'">
            <img title="Private member" alt="Private member" src="../images/icons/privmethod.gif" class="DarkModeAware"/>
          </xsl:when>
          <xsl:when test="@Visibility='Internal'">
            <img title="Internal member" alt="Internal member" src="../images/icons/privmethod.gif" class="DarkModeAware"/>
          </xsl:when>
        </xsl:choose>
      </td>
  ...
  <xsl:template match="doc:DataMemberListEntry">
    <tr class="dataMembersRow">
      <td class="dataMembersData iconColumn">
        ...
        <xsl:choose>
          <xsl:when test="@Visibility='Public'">
            <img title="Public member" alt="Public member" src="../images/icons/pubfield.gif" class="DarkModeAware"/>
          </xsl:when>
          <xsl:when test="@Visibility='Protected'">
            <img title="Protected member" alt="Protected member" src="../images/icons/protfield.gif" class="DarkModeAware"/>
          </xsl:when>
          <xsl:when test="@Visibility='Private'">
            <img title="Private member" alt="Private member" src="../images/icons/privfield.gif" class="DarkModeAware"/>
          </xsl:when>
          <xsl:when test="@Visibility='Internal'">
            <img title="Internal member" alt="Internal member" src="../images/icons/privfield.gif" class="DarkModeAware"/>
          </xsl:when>
        </xsl:choose>
      </td>
      ...
      <td class="dataMembersData typeColumn">
        ...
        <xsl:choose>
          <xsl:when test="contains($nextListEntry,'!')">
            ...
            <xsl:choose>
              <xsl:when test="contains($TypeFilesPresentResolved,concat('[',$nextListEntryPageName,']'))">
  ...
  <xsl:template match="doc:EnumMemberListEntry">
    <tr class="enumMembersRow">
      <td class="enumMembersData iconColumn">
        ...
        <img title="Public Enum" alt="Public Enum" src="../images/icons/pubenumeration.gif" class="DarkModeAware"/>
      </td>
      ...
      <td class="typeMembersData iconColumn">
        ...
        <xsl:choose>
          <xsl:when test="@Visibility='Public'">
            <xsl:choose>
              <xsl:when test="@TypeCategory='Interface'">
                <img title="Public Interface" alt="Public Interface" src="../images/icons/pubinterface.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Class'">
                <img title="Public Class" alt="Public Class" src="../images/icons/pubclass.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Struct'">
                <img title="Public Struct" alt="Public Struct" src="../images/icons/pubstructure.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Enumeration'">
                <img title="Public Enum" alt="Public Enum" src="../images/icons/pubenumeration.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Delegate'">
                <img title="Public Delegate" alt="Public Delegate" src="../images/icons/pubdelegate.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Event'">
                <img title="Public Event" alt="Public Event" src="../images/icons/pubevent.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Library'">
                <img title="Library" alt="Library" src="../images/icons/pubevent.gif" class="DarkModeAware"/>
              </xsl:when>
            </xsl:choose>
          </xsl:when>
          <xsl:when test="@Visibility='Protected'">
            <xsl:choose>
              <xsl:when test="@TypeCategory='Interface'">
                <img title="Protected Interface" alt="Protected Interface" src="../images/icons/protinterface.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Class'">
                <img title="Protected Class" alt="Protected Class" src="../images/icons/protclass.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Struct'">
                <img title="Protected Struct" alt="Protected Struct" src="../images/icons/protstructure.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Enumeration'">
                <img title="Protected Enum" alt="Protected Enum" src="../images/icons/protenumeration.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Delegate'">
                <img title="Protected Delegate" alt="Protected Delegate" src="../images/icons/protdelegate.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Event'">
                <img title="Protected Event" alt="Protected Event" src="../images/icons/protevent.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Library'">
                <img title="Library" alt="Library" src="../images/icons/pubevent.gif" class="DarkModeAware"/>
              </xsl:when>
          ...
          <xsl:when test="@Visibility='Private'">
            <xsl:choose>
              <xsl:when test="@TypeCategory='Interface'">
                <img title="Private Interface" alt="Private Interface" src="../images/icons/privinterface.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Class'">
                <img title="Private Class" alt="Private Class" src="../images/icons/privclass.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Struct'">
                <img title="Private Struct" alt="Private Struct" src="../images/icons/privstructure.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Enumeration'">
                <img title="Private Enum" alt="Private Enum" src="../images/icons/privenumeration.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Delegate'">
                <img title="Private Delegate" alt="Private Delegate" src="../images/icons/privdelegate.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Event'">
                <img title="Private Event" alt="Private Event" src="../images/icons/privevent.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Library'">
                <img title="Library" alt="Library" src="../images/icons/pubevent.gif" class="DarkModeAware"/>
              </xsl:when>
          ...
          <xsl:when test="@Visibility='Internal'">
            <xsl:choose>
              <xsl:when test="@TypeCategory='Interface'">
                <img title="Internal Interface" alt="Internal Interface" src="../images/icons/privinterface.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Class'">
                <img title="Internal Class" alt="Internal Class" src="../images/icons/privclass.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Struct'">
                <img title="Internal Struct" alt="Internal Struct" src="../images/icons/privstructure.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Enumeration'">
                <img title="Internal Enum" alt="Internal Enum" src="../images/icons/privenumeration.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Delegate'">
                <img title="Internal Delegate" alt="Internal Delegate" src="../images/icons/privdelegate.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Event'">
                <img title="Internal Event" alt="Internal Event" src="../images/icons/privevent.gif" class="DarkModeAware"/>
              </xsl:when>
              <xsl:when test="@TypeCategory='Library'">
                <img title="Library" alt="Library" src="../images/icons/pubevent.gif" class="DarkModeAware"/>
              </xsl:when>
